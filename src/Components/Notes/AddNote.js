    ...
    return (
        <div className={styles.AddNoteDiv} >
            ...
            <div id="color" className={styles.color} onClick={toggleHandler} onMouseDown={mouseDownHandler}>
                ...
                <div className={styles.note} contentEditable={true} onClick={()=> document.getElementsByClassName(styles.AddNoteDiv)[0].classList.add(styles.border)}></div>  
                <div className={styles.buttons}> <button className={styles.cancelBtn} onClick={() => document.getElementsByClassName(styles.border)[0].classList.remove(styles.border)}>Cancel</button>       
                <button className={styles.submitBtn} onClick={saveNoteHandler}>Submit</button>   </div>
